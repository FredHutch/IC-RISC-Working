            ...
            fluidRow(
              ...
              column(2,
                ...
                radioButtons("biopsy", label= p("Biopsy results", style="color:green"),
                             choices = c("No dysplasia"= 0, "LG dysp"= 1, "HG dysp or DNA abnorm"= 2), selected= 0))),
...
tabPanel("Body Mass Index",
         ...
         fluidRow(
           ...
           column(5, h3(textOutput("mybmi")), hr(), br(), br(),
                  h4("More information on BMI and health can be found at the", br(), br(),
    ...
    tabPanel("Physical Activity",
         ...
         fluidRow(
           ...
           column(4, h3(htmlOutput("myPA")), hr(), br(), br(),
                  h4("More information on physical activity and health can be found at the", br(), br(),
